...
- **Server file**: `server/status-board.js`
  ...
  - **After a restart**, provider health is restored from disk-persisted caches — weather, wave, and flight providers show as online immediately rather than waiting for the next live poll.
